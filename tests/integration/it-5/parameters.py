...
# A1. Fechas --> [str]
start_date = '2023-10-01' #Fecha de inicio en formato 'YYYY-MM-DD' (str)
start_time = '00:00:00' #Hora de inicio en formato 'HH:mm:ss' (str)
end_date = '2023-10-03' #Fecha de fin en formato 'YYYY-MM-DD' (str)
...
coverages = ['/Soil_Moisture_Retrieval_Data_AM/surface_temperature',
